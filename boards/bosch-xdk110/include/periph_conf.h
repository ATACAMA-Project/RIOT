...
/**
 * @ingroup     boards_bosch-xdk110
 * @{
 *
 * @file
 * @brief       Configuration of CPU peripherals for Bosch XDK 110 board
 *
 * @author      SimonIT <simonit.orig@gmail.com>
 */
...
static const i2c_conf_t i2c_config[] = {
        {
                .dev = I2C0,
                .sda_pin = GPIO_PIN(PD, 14),
                .scl_pin = GPIO_PIN(PD, 15),
        ...
        {
                .dev = I2C1,
                .sda_pin = GPIO_PIN(PB, 11),
                .scl_pin = GPIO_PIN(PB, 12),
...
static const spi_dev_t spi_config[] = {
        {
                .dev = USART2,
                .mosi_pin = GPIO_PIN(PB, 3),
                .miso_pin = GPIO_PIN(PB, 4),
                .clk_pin = GPIO_PIN(PB, 5),
