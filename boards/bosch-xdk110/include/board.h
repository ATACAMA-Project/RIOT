 ...
 *
 * @file
 * @brief       Board specific definitions for the Bosch XDK 110
 *
 ...
 * @{
 */
#define PB0_PIN             GPIO_PIN(PE, 9)
#define PB1_PIN             GPIO_PIN(PE, 14)
/** @} */
